...
outPath <- paste(rootPath, '04_result\\Lasso\\iteration1-10\\scale', sep='')
...
result_list <- sfClusterApplyLB(1:n.iter, run_lasso_iter,
                                ...
                                wt_list=wt_list, k.folds=k.folds, crit=crit, traceFile=traceFile, is.scale=is.scale)
