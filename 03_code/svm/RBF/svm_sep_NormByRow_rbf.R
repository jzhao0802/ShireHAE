...
cost_list <- c(0.00001, 0.00005, 0.0001, 0.001)
gamma_list <- c(0.0001, 0.001, 0.01, 0.1, 0.5) 

iter=1
clsMethod <- ifelse(ONE, 'one-classification', 'C-classification')
folder <- ifelse(test_1fold_flag, 'test_1fold', 'CV')
...
source("F:\\Jie\\Shire_project\\03_code\\svm\\RBF\\svm_subFunc_Dec03_normByRow_rbf.R")
