...
foldid_hae <- createFolds(1:nrow(trainHAE), 5)
...
traceFile1 <- paste(outPath, '\\traceFile_coef.csv', sep='')
or_coef <- get_or_coef(grid, train_data, n.cpu, traceFile1)
