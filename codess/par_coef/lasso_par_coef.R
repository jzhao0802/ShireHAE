...
outPath <- paste(rootPath, '04_result\\lasso\\parCoef\\wt(', wt_str, ')', sep='')
...
source("D:\\Shire_project\\03_code\\Jie\\par_coef\\subFunc_par_coef.R")
or_coef <- get_or_coef_par(trainIdxHAE, nonHaeIdx_train, wt_list, lmd_length, n.cpu, test=T)
