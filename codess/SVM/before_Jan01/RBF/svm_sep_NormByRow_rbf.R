...
cost_list <- c(0.0001, 0.0005, 0.005)
#gamma_list <- c(0.1, 0.3, 0.5) 
#gamma_list <- c(0.001, 0.005, 0.01, 0.05, seq(0.1, 1, 0.3), 10, 50, 100, 300, 500, 800, 1000)
gamma_list <- c(0.0001, 0.0005, 0.001, 0.005, 0.01, 0.05, seq(0.1, 1, 0.3))
